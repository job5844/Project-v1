       ...
       <a-layout-sider width="200" style="background: #fff">
         ...
         >
           <a-sub-menu key="sub1">
             ...
             <a-menu-item key="1" @click="currentComponent = 'dashboard'">Stock Overview</a-menu-item>
             <a-menu-item key="2" @click="currentComponent = 'products'">จัดการสินค้า</a-menu-item>
        ...
        <a-layout-content :style="{ padding: '0 24px', minHeight: '280px' }">
          <template v-if="currentComponent === 'dashboard'">
            <a-row :gutter="16">
              <a-col :span="8">
                <a-card 
          ...
          <template v-else-if="currentComponent === 'products'">
           <product-manager />
         </template>
          </a-layout-content>
        </a-layout>
